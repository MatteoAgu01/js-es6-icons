...
// Fill the select with the data in the icons structure
// Hold the type of data
let types = new Array("all");

// Get the type of data and fill the array
		...
		if(element.type == item || item == "all"){
			...
			<div class="myExCard">
				<div class="d-flex flex-column align-items-center justify-content-center card p-2 py-3 display-2">
					<i class="${element.prefix}${element.family} ${element.prefix}${element.name} py-2" style="color: ${rndColor};"></i>
